...
const Transfer = () => {
  ...
  const { actualUser, setTransferTarget, setIsLogged } = useUser()
    ...
    <section className="transfer-section">
      <div className="transfer-area">
        ...
        <button
          ...
          onClick={() => catchUseToTransfer(useToTransfer)}
        >
          Transferir
        </button>
        {userNotFound && (
          <span className="error-message">Não há nenhum usuário com este email.</span>
        )}
